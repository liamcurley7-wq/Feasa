...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-sub { font-size: 18px; line-height: 1.65; color: var(--ink-light); max-width: 500px; margin-bottom: 48px; font-weight: 300; }
  ...
  .hero-stats { display: flex; gap: 48px; margin-top: 72px; padding-top: 48px; border-top: 1px solid var(--border); }
  ...
  .section-sub { font-size: 16px; color: var(--ink-light); max-width: 480px; line-height: 1.65; margin-bottom: 64px; font-weight: 300; }
    ...
    <div>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-sub">Irish property developers spend weeks pulling together feasibility studies across spreadsheets, PDFs and phone calls. Feasa replaces that entire process — full appraisal, QS breakdown, cash flow and revenue modelling, calibrated to Irish data.</p>
          ...
          <div className="hero-stats">
            <div><div className="hero-stat-value">31</div><div className="hero-stat-label">Local authorities covered</div></div>
            <div><div className="hero-stat-value">Zero</div><div className="hero-stat-label">Competitors in Ireland</div></div>
            <div><div className="hero-stat-value">Weeks</div><div className="hero-stat-label">Saved per appraisal</div></div>
          </div>
        </div>
      ...
      <div className="logos">
        ...
        <div className="logos-row">
          {["Property Price Register","SCSI","MyPlan.ie","CSO","RTB","Tailte Éireann"].map((l,i)=>(<div key={i} className="logo-item">{l}</div>))}
        </div>
      </div>
      ...
      <section className="features">
        ...
        <div className="features-grid">
          {[
            {icon:<svg viewBox="0 0 24 24" strokeWidth="1.5" stroke="#4A9B73" fill="none" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>,title:"Full development appraisal",desc:"GDV, net GDV, total costs, profit on GDV, profit on cost — the complete picture in one view."},
            {icon:<svg viewBox="0 0 24 24" strokeWidth="1.5" stroke="#4A9B73" fill="none" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>,title:"Monthly cash flow",desc:"S-curve construction spend, phased professional fees, and rolling interest calculation with peak funding requirement."},
            {icon:<svg viewBox="0 0 24 24" strokeWidth="1.5" stroke="#4A9B73" fill="none" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>,title:"QS cost engine",desc:"16-element elemental breakdown calibrated to Irish rates. Substructure to contingency, with regional adjustments."},
            {icon:<svg viewBox="0 0 24 24" strokeWidth="1.5" stroke="#4A9B73" fill="none" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>,title:"Residual land value",desc:"Works backwards from your target margin to tell you the maximum you should pay for any site."},
            {icon:<svg viewBox="0 0 24 24" strokeWidth="1.5" stroke="#4A9B73" fill="none" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><path d="M18 20V10"/><path d="M12 20V4"/><path d="M6 20v-6"/></svg>,title:"Sensitivity analysis",desc:"Colour-coded matrix across cost and revenue variations. Six named risk scenarios including worst case and inflation."},
            {icon:<svg viewBox="0 0 24 24" strokeWidth="1.5" stroke="#4A9B73" fill="none" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>,title:"BTR vs BTS comparison",desc:"Side-by-side build-to-rent versus build-to-sell analysis with gross yield, net yield, and payback period."},
          ].map((f,i)=>(
      ...
      <section className="pricing" id="pricing">
        ...
        <div className="pricing-grid">
          {[
            {tier:"Starter",price:"149",desc:"For small developers assessing 1–5 sites per year.",features:["10 feasibility reports/month","Full appraisal and QS breakdown","Cash flow modelling","PDF export","1 user seat"],featured:false},
            {tier:"Professional",price:"299",desc:"For active developers and QS practices running multiple schemes.",features:["Unlimited feasibility reports","All Starter features","Sensitivity analysis","BTR vs BTS comparison","Residual land value","3 user seats","Priority support"],featured:true},
            {tier:"Enterprise",price:"499",desc:"For larger developers and consultancies managing a pipeline.",features:["Everything in Professional","Unlimited user seats","API access","Custom branded reports","Dedicated onboarding","SLA guarantee"],featured:false},
          ].map((p,i)=>(
